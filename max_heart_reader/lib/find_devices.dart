...
void showToast() => Fluttertoast.showToast(msg: globals.toastMessage, fontSize: 16, backgroundColor: const Color.fromARGB(220, 158, 158, 158));
...
class _FindDevicesScreenState extends State<FindDevicesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Timer.periodic(const Duration(seconds: globals.BLE_SCAN_INTERVAL), (Timer t) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () => FlutterBluePlus.instance
            .startScan(timeout: const Duration(seconds: globals.BLE_SCAN_TIMEOUT)),
        ...
        builder: (c, snapshot) {
          if (snapshot.data!) {
            return FloatingActionButton.extended(
              icon: const SizedBox (height: 20, width: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2)),
            ...
            return FloatingActionButton.extended(
              icon: const SizedBox (height: 20, width: 20, child: Icon(Icons.search, color: Colors.white)),
              label: const Text('SCAN'),
              backgroundColor: Colors.orange,
              onPressed: () => FlutterBluePlus.instance.startScan(timeout: const Duration(seconds: globals.BLE_SCAN_TIMEOUT)));
          }
        },
      ),
...
>>>>>>> 49507689e482332cab42c0528da6293902ca4c7f
